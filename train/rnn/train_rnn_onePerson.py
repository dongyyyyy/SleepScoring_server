...
def train_rnn_dataloader_onePerson(save_filename,logging_filename,load_filename,signals_path, train_dataset_list,val_dataset_list,batch_size = 10000,
    ...
    Classification = lstm(flat=512*3,sequence_length=sequence_length,num_layers=num_layers, hidden_dim=hidden_dim)
...
def training_rnn_dataloader_onePerson(use_cudaNum=0,sequence_length=25,window_size=25,num_layers=1,hidden_dim=512):
