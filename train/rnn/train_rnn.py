...
def train_rnn_dataloader(save_filename,logging_filename,load_filename,signals_path, train_dataset_list,val_dataset_list,batch_size = 10000,
                                          ...
                                          sequence_length=10,use_cudaNum=0,len_divide=10,window_size=1):
...
def training_rnn_dataloader(use_cudaNum=0):
    ...
    for scheduler in scheduler_list:
        ...
        save_filename = model_save_path + 'ResNet_ensemble_branch_dataloaer_hallym_%.4f_%s_%s_%s_lstm_%d_%d.pth'%(learning_rate,optim,loss_function,scheduler,sequence_length,window_size)
        logging_filename = logging_save_path + 'ResNet_ensemble_branch_dataloaer_hallym_%.4f_%s_%s_%s_%d_%d.txt'%(learning_rate,optim,loss_function,scheduler,sequence_length,window_size)

        train_rnn_dataloader(save_filename=save_filename,logging_filename=logging_filename,load_filename=load_filename,signals_path=signals_path, train_dataset_list=training_fold_list,val_dataset_list=validation_fold_list,
                                            ...
                                            len_divide=len_divide,window_size=window_size
                                        )
