...
def train_cnn_dataloader(save_filename,logging_filename,signals_path, train_dataset_list,val_dataset_list,batch_size = 10000,
...
def training_cnn_dataloader():
    model_save_path = '/home/eslab/kdy/git/Hallym_SleepStage/saved_model/Hallym_dataset/cnn/'
    logging_save_path = '/home/eslab/kdy/git/Hallym_SleepStage/log/Hallym_dataset/cnn/'
    ...
    for scheduler in scheduler_list:
        for optim in optim_list:
            for learning_rate in learning_rate_list:
                save_filename = model_save_path + 'ResNet_ensemble_branch_dataloaer_hallym_%.4f_%s_%s_%s.txt'%(learning_rate,optim,loss_function,scheduler)
                logging_filename = logging_save_path + 'ResNet_ensemble_branch_dataloaer_hallym_%.4f_%s_%s_%s.pth'%(learning_rate,optim,loss_function,scheduler)

                train_cnn_dataloader(save_filename=save_filename,logging_filename=logging_filename,signals_path=signals_path, train_dataset_list=training_fold_list,val_dataset_list=validation_fold_list,
