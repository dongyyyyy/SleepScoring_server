...
def training_cnn_dataloader_seoul():
    model_save_path = '/home/eslab/kdy/git/Hallym_SleepStage/saved_model/Hallym_dataset/seoul/cnn/'
    logging_save_path = '/home/eslab/kdy/git/Hallym_SleepStage/log/Hallym_dataset/seoul/cnn/'
    validation_len = 200
    os.makedirs(model_save_path,exist_ok=True)
    os.makedirs(logging_save_path,exist_ok=True)
    signals_path = '/home/eslab/dataset/Seoul_dataset/3channel_dataloader/'
